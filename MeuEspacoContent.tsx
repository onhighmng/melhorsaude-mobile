        ...
        {sessions.map((s) => (
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <button
                onClick={() => showSuccessToast('Sessão iniciada', 'A entrar na videochamada...', { duration: 3000 })}
                className="bg-[#1565C0] h-[52px] rounded-full flex items-center justify-center w-full active:scale-[0.98] transition-all shadow-md"
              >
                <Video size={18} className="text-white mr-2" />
                <span className="font-poppins text-white text-[15px] font-bold tracking-wide">Entrar na Sessão</span>
              </button>

              <div className="flex gap-3">
                <button
                  onClick={() => onReschedule(s.id, s.pillar || 'Mental')}
                  className="bg-white/50 border border-black/10 h-[48px] rounded-full flex-1 flex items-center justify-center active:scale-[0.98] transition-all"
                >
                  <RotateCcw size={16} className="text-[#474747] mr-2" />
                  <span className="font-poppins text-[#474747] text-[14px] font-semibold">Reagendar</span>
                </button>
