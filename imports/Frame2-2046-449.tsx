import svgPaths from "./svg-sraqusjjxw";
...
import imgImage from "figma:asset/a710fa471ceb3194f67a019637abaa859fec90f2.png";
import imgMelhorSaudeTransparentLogo1 from "figma:asset/eaf43a5a27ef5bcc503c0ad293ece5ca91f88dc0.png";
import imgMelhorSaudeTransparentClean1 from "figma:asset/f066e727bc45a7068fb1f989657736b83adf0448.png";
type Wrapper1Props = {
...
function Wrapper({ children, additionalClassNames = "" }: React.PropsWithChildren<WrapperProps>) {
  return <Wrapper1 additionalClassNames={clsx("relative rounded-[2.13569e+07px] shrink-0 size-[47.985px]", additionalClassNames)}>{children}</Wrapper1>;
}
...
function MentalHealthCard() {
  return (
    <div className="absolute h-[172.995px] left-0 top-0 w-[156.993px]" data-name="MentalHealthCard">
      <Container />
      <MaskGroup />
      <Paragraph />
      <Paragraph1 />
...
function PhysicalWellnessCard() {
  return (
    <div className="absolute h-[172.995px] left-[169px] top-[0.99px] w-[156.993px]" data-name="PhysicalWellnessCard">
      <Container1 />
      <MaskGroup1 />
      <Paragraph2 />
      <Paragraph3 />
...
function FinancialAssistanceCard() {
  return (
    <div className="absolute h-[172.995px] left-0 top-[192px] w-[156.993px]" data-name="FinancialAssistanceCard">
      <Container2 />
      <MaskGroup2 />
...
function LegalAssistanceCard() {
  return (
    <div className="absolute h-[172.995px] left-[169px] top-[192px] w-[156.993px]" data-name="LegalAssistanceCard">
      <Container3 />
      <MaskGroup3 />
...
function Group1() {
  return (
    <div className="absolute contents left-[-0.99px] top-[88px]">
      <Banner />
      <div className="absolute font-['Source_Serif_Pro:SemiBold',sans-serif] h-[53.256px] leading-[30px] left-[26.01px] not-italic text-[#1a1a1a] text-[28px] top-[110.19px] tracking-[-0.4492px] w-[274px]">
        <p className="mb-0">{`Como estás a sentir-te `}</p>
        <p>hoje?</p>
      </div>
...
function Button3() {
  return (
    <div className="basis-0 grow h-[47.985px] min-h-px min-w-px relative rounded-[2.13569e+07px] shrink-0" data-name="Button">
...
function BottomNav() {
  return (
    <div className="absolute bg-[#1a1a1a] content-stretch flex flex-col h-[71.972px] items-start left-[58.72px] pb-0 pt-[11.994px] px-[23.997px] rounded-[2.13569e+07px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-[764.93px] w-[275.916px]" data-name="BottomNav">
      <Container7 />
    </div>
  );
}
