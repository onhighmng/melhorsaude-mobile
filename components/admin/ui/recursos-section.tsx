						...
						>
							<div className="relative">
								...
								<div className="absolute top-2 right-2 bg-black/70 backdrop-blur-sm text-white px-2 py-1 rounded-md flex items-center gap-1">
									...
									<span className="text-xs" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}>
							...
							<div className="space-y-2 px-1">
								{/* Pillar Badge */}
								<span
									className={`inline-flex px-2.5 py-0.5 rounded-full text-xs ${pillarStyle.bg} ${pillarStyle.text}`}
								...
								<div className="flex items-center gap-1 pt-1 opacity-0 group-hover:opacity-100 transition-opacity">
									<button
										className="flex-1 p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors text-sm flex items-center justify-center gap-1"
										title="Editar"
										style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}
									...
									<button
										className="flex-1 p-2 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors text-sm flex items-center justify-center gap-1"
										title="Apagar"
										style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}
