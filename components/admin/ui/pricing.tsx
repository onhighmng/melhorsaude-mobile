  ...
  return (
    <div className="container py-20">
      <div className="text-center space-y-4 mb-12">
        <h2 className="text-3xl md:text-4xl text-gray-900" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 'bold' }}>
          {title}
        </h2>
        <p className="text-gray-600 text-lg whitespace-pre-line" style={{ fontFamily: 'Inter, sans-serif' }}>
          {description}
        </p>
      </div>

      <div className="flex justify-center mb-10 items-center gap-3">
        <span className="text-gray-700" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 'bold' }}>
          Pagamento Único
        </span>
          ...
          >
            {plan.isPopular && (
              <div className="absolute top-0 right-0 bg-emerald-600 py-0.5 px-2 rounded-bl-xl rounded-tr-xl flex items-center">
                ...
                <span className="text-white ml-1 font-sans" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 'bold' }}>
                  Popular
                </span>
              </div>
            )}
            <div className="flex-1 flex flex-col">
              <p className="text-base text-gray-600" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 'bold' }}>
                {plan.name}
              </p>
              <div className="mt-6 flex items-center justify-center gap-x-2">
                <span className="text-5xl text-gray-900" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 'bold' }}>
                  <NumberFlow
                    value={
              ...
              <ul className="mt-8 gap-3 flex flex-col">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    ...
                    <span className="text-left text-gray-700" style={{ fontFamily: 'Inter, sans-serif' }}>{feature}</span>
                  </li>
                ))}
              </ul>
              ...
              <button
                ...
                className={cn(
                  "group relative w-full gap-2 overflow-hidden text-lg tracking-tight rounded-full py-3 px-6",
              ...
              <p className="mt-4 text-xs leading-5 text-gray-500" style={{ fontFamily: 'Inter, sans-serif' }}>
                {plan.description}
              </p>
            </div>
          </div>
