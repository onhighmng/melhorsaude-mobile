...
import { Button } from '@/components/company-dashboard/ui/button'
import { Badge } from '@/components/company-dashboard/ui/badge'
      ...
      <div className="w-full max-w-5xl mx-auto">
        <div className="flex flex-col items-center gap-4 mb-12">
          <div className="inline-flex items-center p-1.5 bg-white dark:bg-zinc-800/50 rounded-full border border-zinc-200 dark:border-zinc-700 shadow-sm">
            {[
              { label: monthlyLabel, value: false },
              { label: yearlyLabel, value: true }
            ].map((period) => (
              <button
                key={period.label}
                ...
                <div className="mb-6">
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-bold text-zinc-900 dark:text-zinc-100">
                      MZN {isYearly ? tier.price.yearly : tier.price.monthly}
                    </span>
                    <span className="text-sm text-zinc-500 dark:text-zinc-400">
                      /{isYearly ? yearlyLabel.toLowerCase() : monthlyLabel.toLowerCase()}
                    </span>
                  </div>
