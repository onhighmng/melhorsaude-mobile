...
import imgProfileImage1 from '@/assets/company-dashboard/75e0127bb7b629c38fd07f220eac9d0b9a7716a1.png';
import imgProfileImage2 from '@/assets/company-dashboard/6bccb4ec240c4902a2aa5b448c810d434e8aa38b.png';
import imgProfileImage3 from '@/assets/company-dashboard/01afb8e7695a1006b9686d11546c37463dcc151f.png';
  ...
  return (
    <div className="h-[48px] relative shrink-0 w-[424.125px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Manrope:Bold',sans-serif] font-bold leading-[48px] left-0 text-[#0a0a0a] text-[48px] text-nowrap top-[5.5px] mb-32">{t('header.title')}</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  ...
  return (
    <div className="h-[28px] relative shrink-0 w-[550.969px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#0a0a0a] text-[18px] text-nowrap top-0">
          {t('header.welcome')} <TextShimmer 
            as="span"
            duration={2.5}
            spread={3}
            className="text-[18px] leading-[28px] font-['Inter:Regular',sans-serif] font-bold [--base-color:#1e3a8a] [--base-gradient-color:#3b82f6]"
          >
            {t('header.transform')}
          </TextShimmer>
        </p>
    ...
    <div className="h-[230px] relative shrink-0 w-[453.094px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        ...
        <p className="absolute font-['DM_Sans:Regular',sans-serif] font-bold h-[41px] leading-[1.3] left-[226.55px] text-[#575757] text-[16px] text-center top-[162px] translate-x-[-50%] w-[453.094px]" style={{ fontVariationSettings: "'opsz' 14" }}>
          <span>{t('header.opportunity')} </span>
          <TextShimmer 
            as="span"
            duration={2.5}
            spread={3}
