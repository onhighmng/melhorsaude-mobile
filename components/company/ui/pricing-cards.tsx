...
import { TextShimmer } from '@/components/company/ui/text-shimmer';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="rounded-xl border border-gray-200 p-8 bg-white relative select-none">
                    ...
                    <input
                        ...
                        style={{
                            background: `linear-gradient(to right, #1e40af 0%, #1e40af ${(sessionIndex / (SESSION_VALUES.length - 1)) * 100
          ...
          `}</style>
                    ...
                    >
                        <div className="relative">
                            <span className="text-2xl font-bold text-black border-b-2 border-transparent group-hover:border-blue-700 transition-colors">
                                {sessionPrice === null ? "Contacte-nos" : "Adquirir pacote"}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-xl border border-gray-200 p-8 bg-white relative select-none">
                    ...
                    <input
                        ...
                        className="w-full appearance-none h-3 rounded bg-gray-200 mb-8"
                        style={{
                            background: `linear-gradient(to right, #1e40af 0%, #1e40af ${(seatIndex / (SEAT_VALUES.length - 1)) * 100
                    ...
                    >
                        <div className="relative">
                            <span className="text-2xl font-bold text-black border-b-2 border-transparent group-hover:border-blue-700 transition-colors">
                                {seatPrice === null ? "Contacte-nos" : "Adquirir códigos"}
                            </span>
                        </div>
                    </div>
                </div>
