...
import imgProfileImage1 from "@/assets/provider-placeholder.jpg";
import imgProfileImage2 from "@/assets/provider-placeholder.jpg";
import imgProfileImage3 from "@/assets/provider-placeholder.jpg";
    ...
    return (
        <div className="h-[48px] relative shrink-0 w-[424.125px]" data-name="Heading 2">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                <p className="absolute font-['Manrope:Bold',sans-serif] font-bold leading-[48px] left-0 text-[#0a0a0a] text-[48px] text-nowrap top-[5.5px] mb-32">{t('header.title') || "Sua Equipe"}</p>
            </div>
        </div>
    );
}
        ...
        <div className="h-[230px] relative shrink-0 w-[453.094px]" data-name="Paragraph">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                ...
                <p className="absolute font-['DM_Sans:Regular',sans-serif] font-bold h-[41px] leading-[1.3] left-[226.55px] text-[#575757] text-[16px] text-center top-[162px] translate-x-[-50%] w-[453.094px]" style={{ fontVariationSettings: "'opsz' 14" }}>
                    <span>{t('header.opportunity') || "Acesso ilimitado a"} </span>
                    <TextShimmer
                        as="span"
                        duration={2.5}
                        spread={3}
