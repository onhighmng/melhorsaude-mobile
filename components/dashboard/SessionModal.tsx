        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="relative bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 md:p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                    <button
                        className="flex-1 py-3 px-4 bg-[#E3F2FD] text-[#1976D2] rounded-xl hover:bg-[#BBDEFB] transition-colors text-center"
                        onClick={onRebook}
                    >
                        Reagendar
                    </button>
                    {session.meetingLink ? (
                        <a
                            className="flex-1 py-3 px-4 bg-[#E8F5E9] text-[#388E3C] rounded-xl hover:bg-[#C8E6C9] transition-colors text-center cursor-pointer flex items-center justify-center no-underline"
                        ...
                        <button
                            className="flex-1 py-3 px-4 bg-[#E8F5E9] text-[#388E3C] rounded-xl text-center opacity-60 cursor-not-allowed"
                            disabled
                        >
                            Link pendente
                        </button>
                    )}
                    <button className="flex-1 py-3 px-4 bg-[#FFEBEE] text-[#D32F2F] rounded-xl hover:bg-[#FFCDD2] transition-colors text-center" onClick={handleCancelClick}>
                        Cancelar
                    </button>
                </div>
                    ...
                    <div className="absolute inset-0 bg-white rounded-3xl flex items-center justify-center p-6">
                        <div className="text-center space-y-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    className="flex-1 py-3 px-4 bg-[#FFEBEE] text-[#D32F2F] rounded-xl hover:bg-[#FFCDD2] transition-colors"
