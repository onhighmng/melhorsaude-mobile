...
interface FinancialWellbeingQuestionProps {
  onBack: () => void;
  onNext: (selectedConcerns: number[]) => void;
}

export function FinancialWellbeingQuestion({ onBack, onNext }: FinancialWellbeingQuestionProps) {
  const [selectedOptions, setSelectedOptions] = useState<number[]>([]);

  const options = [
    {
      text: "Quero aprender a gerir melhor o meu dinheiro.",
      bgColor: "bg-[#E8F4FD]",
    ...
    {
      text: "Quero poupar com mais consistência.",
      bgColor: "bg-[#FFF4E6]",
    ...
    {
      text: "Quero sair de dívidas ou evitar novos empréstimos.",
      bgColor: "bg-[#E8F9F1]",
    ...
    {
      text: "Quero planear melhor as minhas despesas mensais.",
      bgColor: "bg-[#F5E8FD]",
    ...
    {
      text: "Quero aumentar a minha estabilidade financeira.",
      bgColor: "bg-[#FFE8F0]",
        ...
        <div className="max-w-4xl w-full text-center space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl md:text-5xl text-[#1D1D1F] tracking-tight" style={{ fontFamily: 'Georgia, serif' }}>
              O que mais queres melhorar na tua vida financeira?
            </h1>
