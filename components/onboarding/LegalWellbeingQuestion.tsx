...
interface LegalWellbeingQuestionProps {
  onBack: () => void;
  onNext: (selectedConcerns: number[]) => void;
}

export function LegalWellbeingQuestion({ onBack, onNext }: LegalWellbeingQuestionProps) {
  const [selectedOptions, setSelectedOptions] = useState<number[]>([]);

  const options = [
    {
      text: "Tenho dúvidas sobre contratos ou direitos no trabalho.",
      bgColor: "bg-[#E8F4FD]",
    ...
    {
      text: "Preciso de ajuda com questões familiares (divórcio, pensões, guarda, etc.).",
      bgColor: "bg-[#FFF4E6]",
    ...
    {
      text: "Tenho problemas legais pessoais que não sei como resolver.",
      bgColor: "bg-[#E8F9F1]",
    ...
    {
      text: "Quero prevenir problemas jurídicos antes que aconteçam.",
      bgColor: "bg-[#F5E8FD]",
    ...
    {
      text: "Quero sentir-me mais protegido(a) e confiante nas minhas decisões.",
      bgColor: "bg-[#FFE8F0]",
        ...
        <div className="max-w-4xl w-full text-center space-y-8">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl md:text-5xl text-[#1D1D1F] tracking-tight" style={{ fontFamily: 'Georgia, serif' }}>
              O que mais te preocupa neste momento em relação a assuntos jurídicos?
            </h1>
