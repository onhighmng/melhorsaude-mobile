import imgImage from "../assets/f191302065ab06767212b4e36fab62deeffbfac9.png";

function Icon() {
  return (
    <div className="relative size-[44px] flex items-center justify-center z-10" data-name="Icon">
...
function Badge() {
  return (
    <div className="absolute flex h-[100px] items-center justify-center left-0 top-[107px] w-[100px]" data-name="Badge">
      <Icon />
      <svg className="absolute size-[100px]" viewBox="0 0 100 100" style={{ transform: 'translate(-50%, -50%)', left: '50%', top: '50%', animation: 'spin-left 10s linear infinite' }}>
        ...
        <text className="text-[12px] font-bold" fill="#1e3a8a" letterSpacing="0.5" textAnchor="middle">
...
function Group() {
  return (
    <div className="absolute contents left-0 top-0">
      <div className="absolute h-[316.629px] left-[49.85px] top-0 w-[337.28px] rounded-xl overflow-hidden" data-name="Image">
