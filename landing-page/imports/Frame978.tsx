  ...
  return (
    <div className="relative w-full h-screen bg-cover bg-center flex flex-col items-center justify-center p-4" style={{ backgroundImage: `url(${bgImage})` }}>
      ...
      <div className="absolute top-8 right-8 z-10">
        <div className="flex flex-col font-['SF_Pro_Text:Semibold',sans-serif] justify-center leading-[0] not-italic text-[15px] text-right text-white cursor-pointer hover:opacity-80" onClick={() => onNavigate('home')}>
