import svgPaths from "./svg-xti9qf0jeg";
...
function Button() {
  ...
  return (
    <div
      ...
      className="bg-white content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[15px] relative rounded-[1000px] shadow-[4px_8px_30px_0px_rgba(218,119,231,0.2)] shrink-0 cursor-pointer hover:bg-gray-50 transition-colors"
      data-name="Button"
    >
      <CallCalling />
      <p className="font-['Helvetica_Neue:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#020218] text-[16px] text-center w-[88px]">Registar</p>
    </div>
  );
}
...
function Button1() {
  ...
  return (
    <div
      ...
      className="absolute bg-[#5397f1] content-stretch flex items-center justify-center left-[1132px] px-[16px] py-[15px] rounded-[1000px] shadow-[4px_8px_30px_0px_rgba(218,119,231,0.2)] top-[26px] cursor-pointer hover:bg-[#4278ec] transition-colors"
      data-name="Button"
    >
