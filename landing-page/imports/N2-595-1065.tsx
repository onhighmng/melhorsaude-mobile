...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[32px] items-center left-[calc(50%+20.6px)] top-[15px] translate-x-[-50%]">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[20.04px] relative shrink-0 text-[#4278ec] text-[18px] tracking-[-0.18px] whitespace-pre">Início</p>
      ...
      <div className="capitalize flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#667085] text-[18px] whitespace-nowrap">
...
function ButtonBase() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[71.141px]" data-name="Button.base">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10.02px] items-center justify-center px-[20.04px] py-[12.024px] relative size-full">
          <p className="flex-[1_0_0] font-['Sora:SemiBold',sans-serif] font-semibold leading-[26.052px] min-h-px min-w-px relative text-[#050505] text-[16.032px] text-center whitespace-pre-wrap">Contactar</p>
        </div>
      </div>
    </div>
  );
...
function ButtonBase1() {
  return (
    <div className="bg-[#4278ec] flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[71.141px]" data-name="Button.base">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10.02px] items-center justify-center px-[20.04px] py-[12.024px] relative size-full">
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-center left-[1133px] top-[13px]">
      <Button />
      <div className="flex h-[13.026px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "19" } as React.CSSProperties}>
...
function ImageMelhorSaude() {
  return (
    <div className="h-[21px] relative shrink-0 w-[226px]" data-name="Image (Melhor Saúde)">
      <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgImageMelhorSaude} />
    </div>
  );
}
