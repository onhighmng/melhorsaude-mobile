...
import svgPaths from "./svg-y2c0xrhkkl";
    ...
    return (
        <div className="w-full max-w-[345px] mt-8">
            <div className="mb-4 text-center">
                 <h2 className="font-['SF_Pro_Text:Semibold',sans-serif] text-[24px] text-white">What's your email?</h2>
            </div>
            <Wrapper>
                <input 
                    type="email" 
                    placeholder="john@doe.com"
                    className="w-full bg-transparent border-none outline-none font-['SF_Pro_Text:Regular',sans-serif] text-[17px] text-white placeholder-white/50 text-center"
                    autoFocus
                />
            </Wrapper>
             <div className="mt-2 text-center">
                 <p className="font-['SF_Pro_Text:Regular',sans-serif] text-white/70 text-[14px]">We'll send you a verification code.</p>
            </div>
        </div>
    )
}

export default function EnterEmail({ onNavigate }: FrameProps) {
