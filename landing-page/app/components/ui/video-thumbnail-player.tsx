...
import { cn } from "/src/landing-page/app/components/ui/utils";
  ...
  (
    ...
    return (
      <>
        ...
        {isModalOpen && (
          <div
            className="fixed inset-0 z-[10000] flex animate-in fade-in-0 items-center justify-center bg-black/80 backdrop-blur-sm"
            aria-modal="true"
            role="dialog"
          >
            {/* Close Button */}
            <button
              ...
              className="absolute right-4 top-4 z-[10001] rounded-full bg-white/10 p-2 text-white transition-colors hover:bg-white/20"
            ...
            {/* Video Player */}
            <div className="w-full max-w-4xl aspect-video p-4 bg-black rounded-lg overflow-hidden">
